...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionMakeBold = new QAction(MainWindow);
        actionMakeBold->setObjectName("actionMakeBold");
        actionMakeBold->setMenuRole(QAction::MenuRole::NoRole);
        actionMakeItalic = new QAction(MainWindow);
        actionMakeItalic->setObjectName("actionMakeItalic");
        actionMakeItalic->setMenuRole(QAction::MenuRole::NoRole);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionChangeFont->setText(QCoreApplication::translate("MainWindow", "ChangeFont", nullptr));
